...
tf.app.flags.DEFINE_integer('train_batch_size', 16, 'number of elements in a training batch')
tf.app.flags.DEFINE_integer('val_batch_size', 32, 'number of elements in a validation batch')
tf.app.flags.DEFINE_integer('test_batch_size', 32, 'number of elements in a testing batch')

tf.app.flags.DEFINE_integer('height_of_image', 128, 'Height of the images.')
tf.app.flags.DEFINE_integer('width_of_image', 1, 'Width of the images.')
tf.app.flags.DEFINE_integer('num_channels', 1, 'Number of the channels of the images.')
tf.app.flags.DEFINE_integer('num_classes', 6, 'Number of classes.')
...
tf.app.flags.DEFINE_string('base_dir', '/Users/mariam/Desktop/ASDS/Deep_Learning/project/CNN/results', 'Directory in which results will be stored.')
